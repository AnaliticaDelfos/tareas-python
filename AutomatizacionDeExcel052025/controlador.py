...
class Controlador:
    ...
    def validar_fecha(tarea):
        fechas = {
            "0": datetime(2025, 7, 8, 23, 59, 59, tzinfo=timezone.utc),
            ...
            "4": datetime(2025, 6, 30, 23, 59, 59, tzinfo=timezone.utc),
            "5": datetime(2025, 6, 30, 23, 59, 59, tzinfo=timezone.utc),
            "6": datetime(2025, 6, 30, 23, 59, 59, tzinfo=timezone.utc),
