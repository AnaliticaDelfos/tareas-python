...
class Controlador:
    ...
    def validar_fecha(tarea):
        fechas = {
            "0": datetime(2026, 7, 8, 23, 59, 59, tzinfo=timezone.utc),
            "1": datetime(2026, 7, 8, 23, 59, 59, tzinfo=timezone.utc),
            "2": datetime(2026, 7, 8, 23, 59, 59, tzinfo=timezone.utc),
            "3": datetime(2026, 7, 8, 23, 59, 59, tzinfo=timezone.utc),
            "4": datetime(2026, 6, 29, 23, 59, 59, tzinfo=timezone.utc),
            "5": datetime(2026, 6, 29, 23, 59, 59, tzinfo=timezone.utc),
            "6": datetime(2026, 6, 29, 23, 59, 59, tzinfo=timezone.utc),
            "7": datetime(2026, 6, 19, 23, 59, 59, tzinfo=timezone.utc),
        }
